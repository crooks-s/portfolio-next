    ...
    <div>
      ...
      >
        <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 ">
          {liveUrl ?
            <Link href={liveUrl} target='_blank' className="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7bE] hover:border-white">
          ...
          <Link href={gitUrl} target='_blank' className="h-14 w-14 border-2 relative rounded-full border-[#ADB7bE] hover:border-white">
